      ...
      <div style={{ width: '100%', maxWidth: 400 }}>
        ...
        {step === 'done' && (
          <div className="animate-slide-up" style={{ display: 'flex', flexDirection: 'column', gap: 16, textAlign: 'center' }}>
            <div style={{ background: S.bg1, border: '1px solid ' + S.green + '44', borderRadius: 20, padding: 24 }}>
              <div style={{ fontSize: 14, color: S.green, fontWeight: 700, marginBottom: 16 }}>Profil ghost créé ✓</div>
              ...
              <div style={{ marginBottom: 16 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12 }}>
                  <span style={{ fontSize: 36, fontWeight: 800, color: S.p300, letterSpacing: '0.15em', fontFamily: 'monospace' }}>{ghostCode}</span>
                  <button onClick={copyCode} style={{ background: codeCopied ? S.green + '22' : S.bg2, border: '1px solid ' + (codeCopied ? S.green : S.border), borderRadius: 10, padding: 8, cursor: 'pointer', color: codeCopied ? S.green : S.tx3 }}>
              ...
              <div style={{ display: 'flex', gap: 12, justifyContent: 'center', marginBottom: 16 }}>
                <div style={{ background: S.bg0, borderRadius: 12, padding: '10px 16px', border: '1px solid ' + S.border }}>
              ...
              <div style={{ background: S.yellow + '14', border: '1px solid ' + S.yellow + '33', borderRadius: 12, padding: 12, marginBottom: 4 }}>
                <p style={{ fontSize: 12, color: S.yellow, margin: 0, fontWeight: 600 }}>
