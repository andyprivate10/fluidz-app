          ...
          <div className="animate-slide-up" style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            {isDev && (
              <div style={{ marginTop: 16, background: C.bg2, borderRadius: R.block, padding: 14, border: `1px solid ${C.rule2}` }}>
                ...
                <button onClick={devLogin} style={{ width: '100%', padding: 8, borderRadius: R.chip, ...typeStyle('label'), color: C.red, border: `1px solid ${C.red}3d`, background: 'transparent', cursor: 'pointer' }}>DEV Sign in</button>
              </div>
            )}
          </div>
        )}
